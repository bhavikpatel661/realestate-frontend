  ...
  data() {
    return {
      ...
      loggedInNavRoutes: [
        {
          name: 'profile',
          title: () => 'Logged in as ' + this.currentUser.user.email,
        },
        {
          name: 'logout',
          title: 'Log out',
          ...
          <div class="header-left">
            <div class="me-5 agenda">
              <a href="javascript:void(0);" class="btn btn-primary"
                ><i class="fas fa-calendar"></i>Agenda (24)</a
              >
            </div>
            <div class="nav-item">
          ...
          <ul class="navbar-nav header-right">
            <li class="nav-item dropdown notification_dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end">
                <div
                  ...
                  class="widget-media dz-scroll p-3 ps"
                  style="height:380px;"
                >
                  <ul class="timeline">
                    <li>
                  ...
                  <ul class="timeline">
                    ...
                    <li>
                      ...
                      >
                        ...
                        <h6 class="mb-0"
                          >New order placed
                          <strong class="text-info">#XF-2356.</strong></h6
                        >
                        <p class="mb-0"
                    ...
                    <li>
                      ...
                      >
                        ...
                        <h6 class="mb-0"
                          ...
                          <strong class="text-warning">Sell $250</strong></h6
                        >
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      >
                        <span>20 minutes ago</span>
                        <h6 class="mb-0"
                          >Mashable, a news website and blog, goes live.</h6
                        >
                      </a>
                    </li>
                    <li>
            ...
            <li class="nav-item dropdown notification_dropdown">
              <a class="nav-link bell-link " href="javascript:void(0);">
                ...
                <span class="badge light text-white bg-orange rounded-circle"
                  >76</span
                >
              </a>
            </li>
